...
export function CalendarUI({
  ...
  return (
    <MainLayout
      ...
      className="pt-0 relative overflow-x-hidden"
    >
                ...
                <div className="w-full space-y-3">
                  <Calendar
                    ...
                    classNames={{
                      ...
                      caption:
                        "flex justify-center pt-1 pb-2 relative items-center w-full mb-1 border-b border-primary/5",
                      caption_label: "text-sm font-bold text-foreground/80",
                      nav: "space-x-1 flex items-center",
                      nav_button:
                        "h-7 w-7 bg-transparent p-0 opacity-70 hover:opacity-100 hover:bg-primary/10 hover:text-primary rounded-lg transition-all border border-transparent hover:border-primary/20",
                      nav_button_previous: "absolute left-2",
                      nav_button_next: "absolute right-2",
                      table: "w-full border-collapse",
                      head_row: "flex w-full justify-between mb-1",
                      head_cell:
                        "text-primary/60 rounded-md w-full font-bold text-[8px] sm:text-[9px] text-center uppercase tracking-widest",
        ...
        <AlertDialogContent className="max-w-[400px]">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              event from the academic calendar.
            </AlertDialogDescription>
          </AlertDialogHeader>
