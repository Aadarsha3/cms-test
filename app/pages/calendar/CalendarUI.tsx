...
import { Legend as CalendarLegend } from "./components/Legend";
                            ...
                            {isLoading ? (
                                ...
                                <div className="w-full space-y-6">
                                    <Calendar
                                        ...
                                        className="rounded-2xl bg-white/40 dark:bg-black/20 border border-primary/5 p-2 sm:p-4 shadow-sm backdrop-blur-sm"
                                        classNames={{
                                        ...
                                        components={{
                                            DayContent: (props) => <DayCell date={props.date} events={events} />
                                        }}
                                    />
                                    <div className="pt-2">
                                        <CalendarLegend />
